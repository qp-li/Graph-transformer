...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', type=str, required=False, default='/media/wuhan2021/HIKVISION/ISPRS-Oxford/dataset/benchmark_datasets/', help='Dataset root folder')
