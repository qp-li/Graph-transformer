...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', '-d', type=str, required=False, default="/media/wuhan2021/ZX1 512G/KITTI-360/0.KITTI-360-data/data_3d_raw/2013_05_28_drive_0006_sync/velodyne_points/data/", help='Dataset to calculate content. No Default')
    ...
    parser.add_argument('--output_label', type=str, required=False, default="/media/wuhan2021/ZX1 512G/KITTI-360/0.360-graph/06/", help='Output path for labels')
    parser.add_argument('--output_graph', type=str, required=False, default="/media/wuhan2021/ZX1 512G/KITTI-360/0.360-graph/06/", help='Output path for labels')
    ...
    # does sequence folder exist?
    label_paths = '/media/wuhan2021/ZX1 512G/KITTI-360/label_test/cylinder_label/06'
    ...
    poses_path = '/media/wuhan2021/ZX1 512G/KITTI-360/4.poses/2013_05_28_drive_0006_sync/poses.txt'
