...
def Visualize(sem_label_set, sem_label, points):
    ...
    for id_i, label_i in enumerate(sem_label_set):
        ...
        open3d.visualization.draw_geometries([point_cloud], window_name='semantic label:' + str(111),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', '-d', type=str, required=False, default="/media/wuhan2021/ZX1 512G/KITTI-360/0.KITTI-360-data/data_3d_raw/2013_05_28_drive_0005_sync/velodyne_points/data/", help='Dataset to calculate content. No Default')
    ...
    parser.add_argument('--output_label', type=str, required=False, default="/media/wuhan2021/ZX1 512G/KITTI-360/0.360-graph/05/", help='Output path for labels')
    parser.add_argument('--output_graph', type=str, required=False, default="/media/wuhan2021/ZX1 512G/KITTI-360/0.360-graph/05/", help='Output path for labels')
    ...
    #
    # prepare output dir
    label_output_dir = FLAGS.output_label
    if not os.path.exists(label_output_dir):
        os.makedirs(label_output_dir)

    graph_output_dir = FLAGS.output_graph
    if not os.path.exists(graph_output_dir):
        os.makedirs(graph_output_dir)

    # does sequence folder exist?
    scan_paths = FLAGS.dataset
    ...
    # does sequence folder exist?
    label_paths = '/media/wuhan2021/ZX1 512G/KITTI-360/label_test/cylinder_label/05'
    ...
    # poses = posedata[:, 1:].reshape(-1, 3, 4)[:, 0:2, 3].tolist()

    poses_path = '/media/wuhan2021/ZX1 512G/KITTI-360/4.poses/2013_05_28_drive_0005_sync/poses.txt'
