        ...
        for id_i, label_i in enumerate(sem_label_set):
            ...
            if label_i in [9, 10]:    # road/parking, dont need to cluster
                ...
                for j, indices in enumerate(cluster_indices):
                    ...
                    inst_id = inst_id + 1
                    cluster.extend(inst_cluster) # Nx6
        Visualize(sem_label_set, inst_cluster, points)
...
if __name__ == '__main__':
    ...
    scan_paths = '/media/wuhan2021/ZX1-white/Datasets/SemanticKitti/sequences/00/velodyne/'
    ...
    # does sequence folder exist?
    label_paths = '/media/wuhan2021/ZX1-white/Datasets/SemanticKitti/sequences/00/labels/'
    ...
    poses_path = '/media/wuhan2021/ZX1 512G/KITTI-360/4.poses/2013_05_28_drive_0004_sync/poses.txt'
